    ...
    if (!this.state.meals) {
      return (
        <View style={styles.container}>
          ...
          <Relaxation
            current={this.state.relaxation}
            relaxation={this.relaxation}
          />
          <Button title="On To Meals" onPress={this.meals} />
        </View>
      );
    } else {
      return (
        <View style={styles.meals}>
          ...
          <ModalSelector
            ...
            data={data}
            onChange={option => {
              this.setState({ breakfast: option.label });
            }}
          />
          ...
          <ModalSelector
            ...
            data={data}
            onChange={option => {
              this.setState({ lunch: option.label });
            }}
          />
          ...
          <ModalSelector
            ...
            data={data}
            onChange={option => {
              this.setState({ dinner: option.label });
            }}
          />
          ...
          <ModalSelector
            ...
            data={data}
            onChange={option => {
              this.setState({ snacks: option.label });
            }}
          />
          <Button title="Back To Activities" onPress={this.meals} />
          <Button title="Submit Todays Routine" onPress={this.submitActions} />
        </View>
      );
    }
  }
